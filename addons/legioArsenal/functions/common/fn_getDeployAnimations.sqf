/* ----------------------------------------------------------------------------
Function: LXII_tl_legioArsenal_fnc_getDeployAnimations
...
Examples:
	[_vehicle] call LXII_tl_legioArsenal_fnc_getDeployAnimations;
...
[format["Received data: %1, %2, %3", _vehicle, _vehicleClass, _vehicleConfig], "legioArsenal\functions\common\fn_getDeployAnimations.sqf"] call LXII_tl_legioArsenal_fnc_log;
...
// };
// [format["Checking Config: %1", _animationClasses], "core\functions\common\fn_getDeployAnimations.sqf"] call LXII_tl_legioArsenal_fnc_log;
