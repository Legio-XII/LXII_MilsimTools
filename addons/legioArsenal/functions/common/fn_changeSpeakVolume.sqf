/* ----------------------------------------------------------------------------
Function: LXII_tl_legioArsenal_fnc_changeSpeakVolume
...
Examples:
	[] call LXII_tl_legioArsenal_fnc_changeSpeakVolume;
...
[format["Found the next speak volume: %1 %2", _nextSpeakVolume, _speakMeters select _nextSpeakVolumeIndex], "legioArsenal\functions\fn_changeSpeakVolume.sqf"] call LXII_tl_legioArsenal_fnc_log;
