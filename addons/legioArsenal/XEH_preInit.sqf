...
License GPL-2.0
*/
private _LXII_tl_legioArsenal_settings = [
    [
		"LXII_tl_legioArsenal_debug",
		"CHECKBOX",
	...
	[
		"LXII_tl_legioArsenal_arsenal_objects",
		"EDITBOX",
	...
	[
		"LXII_tl_legioArsenal_map_volume",
		"SLIDER",
	...
	[
		"LXII_tl_legioArsenal_arsenal_whitelist_mission",
		"EDITBOX",
	...
	[
        "LXII_tl_legioArsenal_arsenal_whitelist_Kasrkin",
        "EDITBOX",
...
{_x call CBA_Settings_fnc_init;} forEach _LXII_tl_legioArsenal_settings;
