...
if !([] call LXII_CORE_admin_messages_fnc_isAdminOrZeus) exitWith {_ctrl ctrlShow false};
...
if (!isNil "LXII_CORE_admin_messages_latestConvos" && {count LXII_CORE_admin_messages_latestConvos > 0}) then {
	["STR_LXII_CORE_ADMIN_MESSAGES_LATESTCONVOS"] call _fnc_addHeadline;
	{
		_x call _fnc_addEntry;
		false
	} count LXII_CORE_admin_messages_latestConvos;
	["",-1] call _fnc_addEntry;
};


//BY SIDE ======================================================================
["STR_LXII_CORE_ADMIN_MESSAGES_BYCATEGORY"] call _fnc_addHeadline;
[localize "STR_LXII_CORE_ADMIN_MESSAGES_EVERYONE",-2] call _fnc_addEntry;
[localize "STR_LXII_CORE_ADMIN_MESSAGES_OTHERADMINS",-3] call _fnc_addEntry;
...
//LIST OF PLAYERS ==============================================================
["STR_LXII_CORE_ADMIN_MESSAGES_BYPLAYER"] call _fnc_addHeadline;
private _playerData = [];
{
